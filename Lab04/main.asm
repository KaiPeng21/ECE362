...
ssec	rmb	1	; packed BCD storage for seconds
...
main
	...
	fcb	CR,LF
	fcc	"Created by:  Chia-Hua Peng 2220-P"
	fcb	CR,LF
	fcc	"Last updated:  9/18/2016"
	fcb	CR,LF,NULL
